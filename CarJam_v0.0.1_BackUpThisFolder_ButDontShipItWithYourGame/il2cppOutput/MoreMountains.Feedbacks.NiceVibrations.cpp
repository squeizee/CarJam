...
IL_001d:
	...
	}
	{
		...
		RuntimeObject* L_18;
		L_18 = VirtualFuncInvoker0< RuntimeObject* >::Invoke(82 /* System.Collections.IEnumerator MoreMountains.FeedbacksForThirdParty.MMF_NVContinuous::RealtimeModulationCo() */, __this);
		NullCheck(L_17);
...
IL_004d:
	{
		...
		NullCheck(L_21);
		bool L_22;
		L_22 = VirtualFuncInvoker0< bool >::Invoke(68 /* System.Boolean MoreMountains.Feedbacks.MMF_Feedback::get_NormalPlayDirection() */, L_21);
		G_B7_0 = L_20;
		G_B7_1 = __this;
		if (L_22)
		{
...
IL_00f6:
	{
		...
		NullCheck(L_35);
		float L_36;
		L_36 = VirtualFuncInvoker0< float >::Invoke(62 /* System.Single MoreMountains.Feedbacks.MMF_Feedback::get_FinalNormalizedTime() */, L_35);
		NullCheck(L_34);
		float L_37;
		L_37 = AnimationCurve_Evaluate_m50B857043DE251A186032ADBCBB4CEF817F4EE3C(L_34, L_36, NULL);
		il2cpp_codegen_runtime_class_init_inline(HapticController_t79C84438558C558AA45E1D2CF93B5C0253131CBA_il2cpp_TypeInfo_var);
		...
		NullCheck(L_40);
		float L_41;
		L_41 = VirtualFuncInvoker0< float >::Invoke(62 /* System.Single MoreMountains.Feedbacks.MMF_Feedback::get_FinalNormalizedTime() */, L_40);
		NullCheck(L_39);
		float L_42;
		L_42 = AnimationCurve_Evaluate_m50B857043DE251A186032ADBCBB4CEF817F4EE3C(L_39, L_41, NULL);
		HapticController_set_clipFrequencyShift_m46D7B83FD3D5FEFF6B9E039DA1685C58ECFE6612(L_42, NULL);
